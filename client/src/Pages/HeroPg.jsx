    ...
    >
      ...
      ></div>
        <div className="content md:ml-12 flex flex-col flex-1 gap-4 md:gap-8 py-10 px-6 z-10 ">
            <h1 className='font-black text-5xl md:text-6xl'>The Unity Wave</h1>
            <p className='text-lg '>
            ...
            <p className=' bg-white w-[9rem] text-primary px-6 py-3 rounded-lg hover:bg-[#DCEFFB] transition cursor-pointer'>
              Learn More
            </p>
        </div>

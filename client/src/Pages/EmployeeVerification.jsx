...
const EmployeeVerification = () => {
    ...
    const fetchEmployeeData = async () => {
        try {
            const response = await axios.get('https://website-server-p59e.onrender.com/api/employee/get-employee', {
                headers: {
    ...
    const handlePhotoSubmit = async () => {
        try {
            ...
            const response = await axios.post('https://website-server-p59e.onrender.com/api/employee/employee-verification', formData, {
                headers: {
    ...
    const handleHometownSubmit = async () => {
        try {
            const response = await axios.post(
                'https://website-server-p59e.onrender.com/api/employee/employee-verification',

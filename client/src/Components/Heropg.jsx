...
const MainContent = () => {
  return (
    <div className="min-h-screen w-full bg-gray-100 pt-24">
      ...
      <div className="flex flex-col items-center justify-center w-full bg-white p-8 text-center">
        <div className="flex flex-col md:flex-row justify-between w-full max-w-4xl md:space-x-60 items-stretch">

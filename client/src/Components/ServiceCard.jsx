...
const ServiceCard = ({ name, description, image, isEven }) => {
  return (
      ...
      <div className={`service-card flex w-full md:flex-row flex-col justify-around items-center ${isEven ? 'bg-primary text-white md:flex-row' : 'bg-white text-primary md:flex-row-reverse'} `}>
